      ...
      <div class="pt-6 md:p-8 text-center md:text-left space-y-4">
        <blockquote>
          <p>
            ...
            of learning and agility. We're committed to delivering AI chatbot
            solutions that truly meet your needs, driving efficiency and
            customer satisfaction. Your success is our success. Together, we
            will redefine the possibilities of AI, today and every day!"
          </p>
        </blockquote>
