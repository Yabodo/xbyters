<template>
  <div
    class="relative flex flex-col-reverse px-4 mx-auto lg:block lg:flex-col lg:py-16 xl:py-24 md:px-8 sm:max-w-xl md:max-w-full"
  >
    <div
  ...
  setup() {
    onMounted(() => {
      lottie.loadAnimation({
        ...
        loop: true,
        autoplay: true,
        path: "/ai.json", // the path to the animation json
      });
    });
  },
});
